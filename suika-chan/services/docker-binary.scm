  ...
  (shepherd-service
    ...
    (start #~(make-forkexec-constructor
      ...
      #:environment-variables (list
        (string-append "PATH=" #$docker-binary "/bin"))
...
(define docker-binary-service-type
  (service-type
    ...
    (extensions (list
      (service-extension profile-service-type (const (list
        docker-binary)))
      (service-extension shepherd-root-service-type (const (list
        docker-binary-shepherd-service)))
